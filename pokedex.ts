async function displayPokemonOnCard() {
    try {
        ...
        const nameElement = document.querySelector(".pokedex__card__left__name") as HTMLElement;
        const idElement = document.querySelector(".pokedex__card__left__id") as HTMLElement;
        const typesElement = document.querySelector(".pokedex__card__left__types") as HTMLElement;
